...
try {
    ...
    $CONF_DIR = "D:\ELK\logstash-6.6.1\config"
    $CONF_BACKUP_DIR = "D:\ELK\logstash-6.6.1\config.backup"
    $UPLOADS_LOGSTASH_CONF_DIR = "D:\Apache24\uploads\logstash-conf"
    $SERVICE_NAME = "logstash"

    skriv_steg "backup logstash config"
    ...
    skriv_steg "kopierer inn ny logstash config"

#    slett_og_opprett_mappe_og_kopier_filer $CONF_DIR $CONF_BASE_DIR
    slett_og_opprett_mappe $CONF_DIR
    kopier_filer $UPLOADS_LOGSTASH_CONF_DIR $CONF_DIR
    slett_mappe $UPLOADS_LOGSTASH_CONF_DIR
